...
from agents import BasicAgent, BasicAgentPro, NewAgent, NewAgentV2, NewAgentV3, NewAgentV4, NewAgentV5, AgentOthers
...
# Agent A: 你的 NewAgent | Agent B: 别人的 OtherAgent
agent_a, agent_b = NewAgentV5(), BasicAgentPro()
